...
def main():
    ...
    while not window_closed(): 
        ...
        earth.update_velocity(-.1, -.5, TIMESTEP*TIME_SCALE)
        moon.update_velocity(.6,.25,TIMESTEP*TIME_SCALE)
        
        earth.update_position(TIMESTEP*TIME_SCALE)
        moon.update_position(TIMESTEP*TIME_SCALE)
